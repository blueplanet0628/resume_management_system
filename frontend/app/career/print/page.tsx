...
export default function PreviewPage() {
  ...
  const [user, setUser] = useState<{ full_name?: string }>({ full_name: '●●●' }); // Default name
  ...
  const { job, experiences = [], skill, profile } = resumeData;

  return (
    <>
      <div className="bg-white max-w-4xl mx-auto border border-gray-300 shadow">
        <div className="flex no-print justify-end mt-5 mr-5 border-gray-200">
            <button onClick={() => window.print()}  className='px-2 py-1 bg-white border rounded-md'>印刷</button>        
        </div>
